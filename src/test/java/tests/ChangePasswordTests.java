...
public class ChangePasswordTests {
    ...
    public void updatePasswordValid() {
        test = extent.createTest("updatePasswordValid");
    }

    @Test
    public void updatePasswordWithSamePassword() {
        test = extent.createTest("updatePasswordWithSamePassword");
    }

    @Test
    public void updatePasswordWithInvalidPassword() {
        test = extent.createTest("updatePasswordWithInvalidPassword");
    }
